...
?>
       ...
       <!-- Main Footer -->
      <footer class="main-footer" style="background-color:#800080">
        <!-- To the right -->
        <div class="pull-right hidden-xs">
          
        </div>
        <!-- Default to the left -->
        <span style="color:#ffffff;"><center>Copyright &copy; 2022 - Penerapan Metode Fuzzy Servqual untuk Menganalisa Kepuasan Pelanggan Rawat Inap </center></span> 
      </footer>
