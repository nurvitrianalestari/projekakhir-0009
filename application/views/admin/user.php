          		...
          		<div class='row'>
                    ...
                    <input type='hidden' class='sesi-from' value='<?php echo rand(0,100).rand(10,500).date('dym') ?>' >
                      ...
                      <div class='input-group has-feedback'><span class="input-group-addon" id="username"><i class='fa fa-user'></i></span>
          						  <input type='text' class='form-control' id='username12' placeholder='username12' data-toggle='tooltip' data-placement='top' title='Masukkan Username. Harus unique' ><span class='form-control-feedback'></span>
                      </div>
          					</div>
