...
<html>
  ...
  <link rel="stylesheet" href="<?php path_adm() ?>/plugins/datepicker/datepicker3.css">
   ...
   <link href="<?php path_adm() ?>/plugins/datatables/extensions/Responsive/css/responsive.dataTables.css" rel="stylesheet" type="text/css" />
     <!-- DATATABLES -->
    <link href="<?php path_adm() ?>/dist/css/skins/_all-skins.css" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href='<?php echo $burl; ?>' class="logo">
          ...
          <span class="logo-mini">QIM</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">RUMAH SAKIT QIM</span>
        </a>
        <!-- Header Navbar -->
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>admin/all_user" class="btn btn-default btn-flat">Profil</a>
                    </div>
      ...
      <!-- Sidebar user panel (optional) -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header "><b>MANAJEMEN DATA</b></li>
            ...
            <li class='treeview  <?php if(($npage==6)OR($npage==7)){ echo'active';} ?>'>
              ...
              <ul class='treeview-menu'>
                ...
                <li class='<?php if($npage==7){ echo'active';} ?>'><a href='<?php echo $burl; ?>/dimensi/tambah'><i class='fa fa-external-link '></i><span class="">Tambah Dimensi</span></a></li>
              </ul>
            </li>
            <li class='treeview  <?php if(($npage==8) OR ($npage==9) OR ($npage==35)){ echo'active';} ?>'>
              <a href='#'><i class='fa fa-user '></i><span class="">Pasien</span><i class="fa fa-angle-left pull-right "></i></a>
              <ul class='treeview-menu'>
                <li class='<?php if($npage==8){ echo'active';} ?>'><a href='<?php echo $burl; ?>/all_pasien'><i class='fa fa-group '></i><span class="">Semua Pasien</span></a></li>
                <li class='<?php if($npage==9){ echo'active';} ?>'><a href='<?php echo $burl; ?>/pasien'><i class='fa fa-user-plus '></i><span class="">Tambah Pasien</span></a></li>
            ...
            <li class='treeview <?php if($npage==11 || $npage==12 || $npage==13){ echo'active';} ?>'>
              ...
              <ul class='treeview-menu'>
                ...
                <li class="<?php if($npage==12){ echo'active';} ?>"><a href="<?php echo $burl; ?>/all_jenis"><i class='fa fa-institution '></i><span class="">Jenis Pasien</span></a></li>
                <li class="<?php if($npage==13){ echo'active';} ?>"><a href="<?php echo $burl; ?>/all_ruang"><i class='fa fa-graduation-cap '></i><span class="">Data Ruang</span></a></li>
              </ul>
            </li>
          ...
          <!---  <li class='header '><b>LAPORAN</b></li>
            ...
            <li class='treeview <?php if(($npage==21)OR( $npage==22)){ echo'active';} ?>'>
              <a href="#"><i class='fa fa-user '></i><span class="">Pengguna</span><i class="fa fa-angle-left pull-right "></i></a>
              <ul class='treeview-menu'>
               <li class='<?php if($npage==21){ echo'active';} ?>'><a href='<?php echo $burl; ?>/all_user'><i class='fa fa-sitemap '></i><span class="">Managemen Pengguna</span></a></li>
